...
export function VehiculoExportButtons({ vehiculos, inversionistas }: { vehiculos: Vehiculo[]; inversionistas: Inversionista[] }) {
  ...
  const exportExcel = async () => {
    ...
    try {
      const { exportVehiculosToExcel } = await import("@/modules/vehiculo/services/vehiculo-excel.service");
  ...
  const exportPdf = async () => {
    ...
    try {
      const { exportVehiculosToPdf } = await import("@/modules/vehiculo/services/vehiculo-pdf.service");
